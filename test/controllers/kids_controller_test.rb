...
class KidsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create kid" do
    assert_difference('Kid.count') do
      post kids_url, params: { kid: { date_of_birth: @kid.date_of_birth, dni_number: @kid.dni_number, first_name: @kid.first_name, gender: @kid.gender, last_name: @kid.last_name } }
    end
  ...
  test "should update kid" do
    patch kid_url(@kid), params: { kid: { date_of_birth: @kid.date_of_birth, dni_number: @kid.dni_number, first_name: @kid.first_name, gender: @kid.gender, last_name: @kid.last_name } }
